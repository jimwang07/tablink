...
export type Database = {
    ...
    public: {
        ...
        Enums: {
            ...
            receipt_event_type: "item_claimed" | "item_unclaimed" | "item_settled" | "receipt_status_changed" | "participant_added" | "participant_removed" | "payment_requested" | "payment_marked_paid";
            receipt_status: "draft" | "ready" | "shared" | "partially_claimed" | "fully_claimed" | "settled";
...
export declare const Constants: {
    ...
    readonly public: {
        readonly Enums: {
            ...
            readonly item_state: readonly ["unclaimed", "claimed", "settled"];
            readonly participant_role: readonly ["owner", "guest"];
            readonly receipt_event_type: readonly ["item_claimed", "item_unclaimed", "item_settled", "receipt_status_changed", "participant_added", "participant_removed", "payment_requested", "payment_marked_paid"];
            readonly receipt_status: readonly ["draft", "ready", "shared", "partially_claimed", "fully_claimed", "settled"];
            readonly settlement_status: readonly ["open", "requested", "paid"];
        };
    };
};
export {};
